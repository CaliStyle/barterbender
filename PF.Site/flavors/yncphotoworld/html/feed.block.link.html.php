...
<ul class="dropdown-menu dropdown-menu-right">
    ...
    {if Phpfox::isModule('report') && $aFeed.type_id=='user_status' && Phpfox::getUserId() && $aFeed.user_id != Phpfox::getUserId() && !User_Service_Block_Block::instance()->isBlocked(null, $aFeed.user_id)}
