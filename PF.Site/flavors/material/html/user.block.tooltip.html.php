    ...
    <div class="user_tooltip_action_user">
        ...
        <ul>
            ...
            {if $bShowBDay}
                ...
                {if Phpfox::isAppActive('Core_Messages') && User_Service_Privacy_Privacy::instance()->hasAccess('' . $aUser.user_id . '', 'mail.send_message') && (!Phpfox::getUserParam('mail.restrict_message_to_friends') || (Phpfox::getUserParam('mail.restrict_message_to_friends') && isset($aUser.is_friend) && $aUser.is_friend === true))}
