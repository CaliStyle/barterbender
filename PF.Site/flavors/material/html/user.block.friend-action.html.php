...
<ul class="dropdown-menu dropdown-center">
    {if Phpfox::isAppActive('Core_Messages') && User_Service_Privacy_Privacy::instance()->hasAccess('' . $aUser.user_id . '', 'mail.send_message') && (!Phpfox::getUserParam('mail.restrict_message_to_friends') || (Phpfox::getUserParam('mail.restrict_message_to_friends') && $is_friend))}
        <li>
