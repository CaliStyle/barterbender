    ...
    <div class="item-inner">
        ...
        <div class="dropup friend-actions">
            {if Phpfox::isUser() && Phpfox::isModule('friend') && empty($is_friend)}
                ...
                <a href="#" onclick="return $Core.addAsFriend('{$user_id}');" title="{_p var='confirm_friend_request'}" class="btn btn-md btn-default btn-round">
                    <span class="mr-1 ico ico-user2-check-o"></span>
                    {_p var='confirm'}
                </a>
                {elseif Phpfox::getUserParam('friend.can_add_friends')}
                <a href="#" onclick="return $Core.addAsFriend('{$user_id}');" title="{_p var='add_as_friend'}" class="btn btn-md btn-default btn-round">
