...
<div class="app-addnew-block">
    <div class="btn-app-addnew">
        ...
        <a href="{url link=$aSubMenu.url)}" class="btn btn-info btn-gradient js_hover_title {if !empty($aSubMenu.css_name)}{$aSubMenu.css_name}{/if}">
        ...
        <a href="{$aSubMenu.url}" class="btn btn-info btn-gradient js_hover_title {if (isset($aSubMenu.css_class))} {$aSubMenu.css_class}{/if}" {if !empty($aSubMenu.extra)}{$aSubMenu.extra}{/if}>
            <span class="ico ico-plus"></span>
            <span class="js_hover_info">{$aSubMenu.title}</span>
        </a>
        {else}
        <a role="button" class="btn btn-info btn-gradient" data-toggle="dropdown">
            <span class="ico ico-plus"></span>
        </a>
