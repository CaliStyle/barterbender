...
class FeedPostForm extends GeneralForm
{
    ...
    public function buildForm()
    {
        $this->addField('post_type', HiddenType::class, [], [
            ...
            ->addPrivacyField([], null, $this->privacy->getValue('feed.default_privacy_setting'))
    ...
    public function getValues()
    {
        ...
        if (!empty($values['location'])) {
            ...
            $values['location']['latlng'] = $values['location']['lat'] . "," . $values['location']['lng'];
        }
        ...
        if ($values['parent_item_type'] == 'user' && !empty($values['parent_item_id'])) {
