...
class GroupMemberResource extends UserResource
{
    const RESOURCE_NAME = "group-member";
    ...
    {
        return ['resource_name', 'id', 'full_name', 'avatar', 'is_featured', 'statistic', 'is_owner', 'friendship', 'friend_id', 'extra', 'is_pending', 'page_id'];
    }
    ...
    {
        $this->is_pending = !empty($this->rawData['signup_id']);
