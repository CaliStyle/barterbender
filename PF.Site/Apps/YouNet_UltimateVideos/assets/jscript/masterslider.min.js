...
;(function($){
    ...
    window.MSLayerEffects_ynuv = {};

    var installed,
        _fade = {opacity:0};

    MSLayerEffects_ynuv.setup = function(){

        if(installed) return;
        installed = true;

        var st 					= MSLayerEffects_ynuv,
...
;(function($){
    ...
    p._parseEff = function(eff_name){
        ...
        if(eff_name.indexOf('(') !== -1){
            ...
            for(var i = 0 , l = eff_params.length; i < l ; ++i){
                ...
                if(value in MSLayerEffects_ynuv.presetEffParams)
                    value = MSLayerEffects_ynuv.presetEffParams[value];
    ...
    p.start = function(){
        ...
        MSLayerEffects_ynuv.rf = this.resizeFactor;
        var effect_css = MSLayerEffects_ynuv[this.start_anim.eff_name].apply(null , this._parseEffParams(this.start_anim.eff_params));
        ...
        for(key in effect_css){
            ...
            if( MSLayerEffects_ynuv.defaultValues[key] != null ){
                start_css_eff[key] = MSLayerEffects_ynuv.defaultValues[key];
            }
    ...
    p.hide = function(){
        ...
        // reads css value form LayerEffects
        var effect_css = MSLayerEffects_ynuv[this.end_anim.eff_name].apply(null , this._parseEffParams(this.end_anim.eff_params));
...
;(function($){
    ...
    p.slideAction = function(slide){
        ...
        var that = this;
        var thumb_frame = $('<div id="ms-thumb-frame-'+this.index_count+'"></div>')
            .addClass('ms-thumb-frame')
            .append(thumb_ele)
            .append($('<div class="ms-thumb-ol"></div>'));
        //    .bind('click' , function(){that.changeSlide(thumb_frame);});

        $(document).on('click', "#ms-thumb-frame-"+this.index_count, function() {
...
;(function($){
    ...
    p.create = function(){
        ...
        for(var i = 0; i < this.slider.api.count(); ++i){
            var bullet = $('<div id="ms-bullet-'+i+'"></div>').addClass('ms-bullet');
            bullet[0].index = i;
            $(document).on('click', "#ms-bullet-"+i, function() {
