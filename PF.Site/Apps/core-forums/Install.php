    ...
    protected function setSettings()
    {
        $this->settings = [
            ...
            'forum_meta_description' => [
                ...
                'description' => 'Meta description added to pages related to the Forum app. <a role="button" onclick="$Core.editMeta(\'seo_forum_meta_description\', true)">Click here</a> to edit meta description.<span style="float:right;">(SEO) <input style="width:150px;" readonly value="seo_forum_meta_description"></span>',
                'type' => '',
            ...
            'forum_meta_keywords' => [
                ...
                'description' => 'Meta keywords that will be displayed on sections related to the Forum app. <a role="button" onclick="$Core.editMeta(\'seo_forum_meta_keywords\', true)">Click here</a> to edit meta keywords.<span style="float:right;">(SEO) <input style="width:150px;" readonly value="seo_forum_meta_keywords"></span>',
                'type' => '',
            ...
            'forum_allow_create_feed_when_add_new_item' => [
                'var_name' => 'forum_allow_create_feed_when_add_new_item',
