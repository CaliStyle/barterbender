...
<div class="video-view ">
    ...
    {else}
        ...
        {/if}
    {/if}
    <div class="t_center pf_video_wrapper {if $aItem.is_stream}{if empty($aItem.is_facebook_embed)}pf_video_wrapper_iframe{else}pf_video_facebook_iframe{/if}{/if} {if $aItem.destination}pf_video_wrapper_uploader{/if}">
        {$aItem.embed_code}
