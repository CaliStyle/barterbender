...
<div class="pf_video_message" style="display:none;">
    ...
    <div>
        <a href="#" class="pf_v_upload_success_cancel button btn-sm btn-default">{_p('cancel_and_remove_video_uploaded')}</a>
    </div>
</div>
    ...
    <div id="pf_v_share_success_message" style="display: none">
        <div class="alert alert-info">
            ...
            <div class="form-group pt-1">
                <a href="#" class="pf_v_message_cancel button btn-sm btn-default pull-right">{_p('Continue')}</a>
            </div>
        </div>
    </div>
{/if}