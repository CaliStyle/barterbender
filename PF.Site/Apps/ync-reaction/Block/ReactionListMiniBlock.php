...
class ReactionListMiniBlock extends Phpfox_Component
{
    public function process()
    {
        ...
        list($iTotalReact, $aMostReacted) = Phpfox::getService('yncreaction')->getMostReaction($sType, $iItemId,
            $sPrefix);
        if (!$aMostReacted) {
            return false;
        }
    ...
    {
        (($sPlugin = Phpfox_Plugin::get('yncreaction.component_block_reaction_list_mini_clean')) ? eval($sPlugin) : false);
