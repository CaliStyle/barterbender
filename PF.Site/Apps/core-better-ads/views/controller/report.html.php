        ...
        <div class="bts-detail__body__outer mx--1 d-flex flex-wrap">
            <div class="col-md-4 col-sm-6 col-xs-6 col-xsxs-12 pl-1 pr-1 mb-3 flex-column d-inline-flex">
                <div class="bts-detail__body__inner pb-1">
                    ...
                    <div class="bts-detail__body__text">{$aPlacement.title}: {_p var=block x=$aPlacement.block_id} - {if $aPlacement.is_cpm}{_p var='better_ads_cpm_cost_per_mille'}{else}{_p var='better_ads_ppc_pay_per_click'}{/if}</div>
                </div>
            </div>
