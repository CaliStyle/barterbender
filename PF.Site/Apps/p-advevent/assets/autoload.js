var eventAdvSearch = {
    ...
    submitForm: function(obj) {
        ...
        form.find('.js_p_adv_search_wrapper #core_js_messages').html('');

        if(form.find('.js-location_input').val() && empty(form.find('#search_range_value_from').val())) {
            form.find('.js_p_adv_search_wrapper #core_js_messages').html('<div class="error_message">' + oTranslations['fevent_please_fill_in_range_to_search'] + '</div>');
            return false;
        }
    ...
    resetForm: function() {
        ...
        $("input.js-location_input").val('');
        $("input.js-location_lat").val('');
        $("input.js-location_lng").val('');
        $("input.js-location_country_iso").val('');
        $("input.js-location_country_child_id").val('');
