	...
	action: function(oObj, sAction)
	{
		...
		switch (sAction)
		{
			case 'edit':
				...
				break;
			case 'delete':
				if (confirm(oTranslations['fevent.are_you_sure_this_will_delete_all_events_that_belong_to_this_category_and_cannot_be_undone']))
				{
