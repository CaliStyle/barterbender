...
class Ajax extends Phpfox_Ajax
{
    ...
    public function loadAjaxMapView()
    {
        ...
        if ($typeEventMap == 'upcoming') {
            list(, $aEventLocation) = Phpfox::getService('fevent')->getOnHomepageByType('upcoming', $iLimit, $bIsPage, false, $pageId);
        } else if ($typeEventMap == 'ongoing') {
            list(, $aEventLocation) = Phpfox::getService('fevent')->getOnHomepageByType('ongoing', $iLimit, $bIsPage, false, $pageId);
        }
