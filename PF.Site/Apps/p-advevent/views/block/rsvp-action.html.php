...
{if $rsvpActionType == 'list'}
    ...
    <div class="dropdown js_rsvp_content p-fevent-action-simple-dropdown-style-wrapper" data-id="{$aItem.event_id}" data-phrase="{_p var='maybe_attending'}">
    ...
    {else}
    <div class="js_rsvp_content p-fevent-action-simple-style-wrapper" data-id="{$aItem.event_id}">
