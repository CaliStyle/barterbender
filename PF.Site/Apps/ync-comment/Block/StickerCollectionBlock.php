...
class StickerCollectionBlock extends Phpfox_Component
{
    public function process()
    {
        ...
        $iLimit = 8;
        $aUserStickers = Phpfox::getService('ynccomment.stickers')->getAllStickerSetByUser($iUserId, $iLimit);
        $aAllStickers = Phpfox::getService('ynccomment.stickers')->getAllSticker($iUserId, $iLimit);
