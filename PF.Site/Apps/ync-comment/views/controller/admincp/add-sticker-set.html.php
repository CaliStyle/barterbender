...
<form action="{url link='admincp.ynccomment.add-sticker-set'}" method="post" id="js_sticker_set_form" class="ynccomment-acp-sticker">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group" style="border:1px solid #eee;padding: 8px;">
                ...
                {module name='core.upload-form' type='ynccomment' params=$aForms.params}
            </div>
            {/if}
            <div id="js_list_stickers">
                {template file='ynccomment.block.admin.list-stickers'}
            </div>
