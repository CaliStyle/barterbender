...
class Process extends Phpfox_Service
{
    ...
    public function add($aVals, $iUpdateId = null)
    {
        ...
        $this->cache()->remove('activitypoint_packages');
        return $iId;
    }
    ...
    {
        db()->update($this->_sTable, ['is_active' => (int)$bActive],'package_id = '. (int)$iPackageId);
    }
    ...
    public function delete($iPackageId)
    {
        ...
        db()->delete($this->_sTable,'package_id = '. (int)$iPackageId);
        return true;
    }
