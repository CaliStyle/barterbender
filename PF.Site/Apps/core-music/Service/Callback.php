...
class Callback extends \Phpfox_Service
{
    ...
    public function addCommentSong($aVals, $iUserId = null, $sUserName = null)
    {
        ...
        \Phpfox::getService('comment.process')->notify(array(
                ...
                'owner_subject' => array('full_name_commented_on_your_song_title', array(
                    'full_name' => Phpfox::getUserBy('full_name'),
                    'title' => $this->preParse()->clean($aRow['title'], 100)
                )),
                'owner_message' => array('name_commented_on_your_song',
                ...
                'mass_subject' => (Phpfox::getUserId() == $aRow['user_id'] ?
                    array('full_name_commented_on_gender_song', array(
                        'full_name' => Phpfox::getUserBy('full_name'),
                        'gender' => \Phpfox::getService('user')->gender($aRow['gender'], 1)
                    ))
                    :
                    array('full_name_commented_on_other_full_name_s_song',
                        array('full_name' => Phpfox::getUserBy('full_name'), 'other_full_name' => $aRow['full_name']))),
                'mass_message' => (Phpfox::getUserId() == $aRow['user_id'] ?
                    array('full_name_commented_on_gender_song_a_href_link_title_a_to_see_the_comment_thread_folow_the_link_below_a_href_link_link_a',
                        array(
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'gender' => \Phpfox::getService('user')->gender($aRow['gender'], 1),
                            'title' => $aRow['title'],
                    ...
                    :
                    array('full_name_commented_on_other_full_names_song', array(
                        'full_name' => Phpfox::getUserBy('full_name'),
    ...
    public function addCommentPlaylist($aVals, $iUserId = null, $sUserName = null)
    {
        ...
        \Phpfox::getService('comment.process')->notify(array(
                ...
                'owner_subject' => array('full_name_commented_on_your_music_playlist_title', array(
                    'full_name' => Phpfox::getUserBy('full_name'),
                    'title' => $this->preParse()->clean($aRow['name'], 100)
                )),
                'owner_message' => array('full_name_commented_on_your_music_playlist_a_href_link_title_a_to_see_the_commented_thread_follow_the_link_below_a_href_link_link_a',
                ...
                'mass_subject' => (Phpfox::getUserId() == $aRow['user_id'] ?
                    array('full_name_commented_on_gender_album', array(
                        'full_name' => Phpfox::getUserBy('full_name'),
                        'gender' => \Phpfox::getService('user')->gender($aRow['gender'], 1)
                    ))
                    :
                    array('full_name_commented_on_other_full_name_s_music_playlist',
                        array('full_name' => Phpfox::getUserBy('full_name'), 'other_full_name' => $aRow['full_name']))),
                'mass_message' => (Phpfox::getUserId() == $aRow['user_id'] ?
                    array('full_name_commented_on_gender_music_playlist_a_href_link_user_name_a_to_see_the_comment_thread_follow_the_link_below_a_href_link_link_a',
                        array(
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'gender' => \Phpfox::getService('user')->gender($aRow['gender'], 1),
                            'user_name' => $aRow['name'],
                    ...
                    :
                    array('full_name_commented_on_other_full_name_s_music_playlist_a_href_link_user_name_a_to_see_the_comment_thread_follow_the_link_below_a_href_link_link_a',
                        array(
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'other_full_name' => $aRow['full_name'],
                            'link' => $sLink
    ...
    public function addCommentAlbum($aVals, $iUserId = null, $sUserName = null)
    {
        ...
        \Phpfox::getService('comment.process')->notify(array(
                ...
                'owner_subject' => array('full_name_commented_on_your_album_title', array(
                    'full_name' => Phpfox::getUserBy('full_name'),
                    'title' => $this->preParse()->clean($aRow['name'], 100)
                )),
                'owner_message' => array('full_name_commented_on_your_album_a_href_link_title_a_to_see_the_commented_thread_follow_the_link_below_a_href_link_link_a',
                    array('full_name' => Phpfox::getUserBy('full_name'), 'title' => $aRow['name'], 'link' => $sLink)),
                'owner_notification' => 'comment.add_new_comment',
                ...
                'mass_subject' => (Phpfox::getUserId() == $aRow['user_id'] ?
                    ...
                    :
                    array('full_name_commented_on_other_full_name_s_album',
                        array('full_name' => Phpfox::getUserBy('full_name'), 'other_full_name' => $aRow['full_name']))),
                'mass_message' => (Phpfox::getUserId() == $aRow['user_id'] ?
                    array('full_name_commented_on_gender_album_a_href_link_user_name_a_to_see_the_comment_thread_follow_the_link_below_a_href_link_link_a',
                        array(
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'gender' => \Phpfox::getService('user')->gender($aRow['gender'], 1),
                            'user_name' => $aRow['name'],
                    ...
                    :
                    array('full_name_commented_on_other_full_name_s_album_a_href_link_user_name_a_to_see_the_comment_thread_follow_the_link_below_a_href_link_link_a',
                        array(
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'other_full_name' => $aRow['full_name'],
                            'link' => $sLink
    ...
    public function getGlobalPrivacySettings()
    {
        return array(
            ...
            'music.default_privacy_setting_playlist' => array(
    ...
    public function getCommentNotificationAlbumTag($aNotification)
    {
        ...
        $sPhrase = _p('user_name_tagged_you_in_a_comment_in_a_music_album', array(
            'user_name' => Phpfox::getService('notification')->getUsers($aNotification)
        ));
