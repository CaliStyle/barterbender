		...
		<div class="item-outer-action">
			<div class="action-vote-bottom">
				...
				<div class="quizz-group-submit">
					<a href="javascript:void(0);" onclick="tb_show('{_p('quiz_total_plays_title')}', $.ajaxBox('quiz.showTotalPlays', 'quiz_id={$aQuiz.quiz_id}')); return false;" class="item-vote-number">{$aQuiz.total_play|short_number} {if $aQuiz.total_play == 1}{_p('quiz_total_play')}{else}{_p('quiz_total_plays')}{/if}</a>
