 ...
 */
class MinhController extends Phpfox_Component
{
    ...
    public function process()
    {
        ...
        $this->search()->set(array(
                ...
                'search_tool' => array(
                    ...
                    'search' => array(
                        ...
                        'name' => 'search',
                        'field' => array('blog.title', 'blog_text.text_parsed')
                    ),
                    'sort' => array(
        ...
        $aBrowseParams = array(
            ...
            'hide_view' => Phpfox::getService('blog')->getHiddenViews()
        );
        ...
        if ($this->request()->get(($bIsProfile === true ? 'req3' : 'req2')) == 'category') {
            if ($aBlogCategory = Phpfox::getService('blog.category')->getCategory($this->request()->getInt(($bIsProfile === true ? 'req4' : 'req3')), true)) {
