    ...
    public function process()
    {
        ...
        $aMetaKeys = [
            'blog_meta_description' => array(
                'description' => '<title>Blog Meta Description</title><info>Meta description added to pages related to the Blog app. <a role="button" onclick="$Core.editMeta(\'seo_blog_meta_description\', true)">Click here</a> to edit meta description.<span style="float:right;">(SEO) <input style="width:150px;" readonly value="seo_blog_meta_description"></span></info>',
                'meta_value' => 'Read up on the latest blogs on Site Name.'
            ),
            'blog_meta_keywords' => array(
                'description' => '<title>Blog Meta Description</title><info>Meta keywords that will be displayed on sections related to the Blog app. <a role="button" onclick="$Core.editMeta(\'seo_blog_meta_keywords\', true)">Click here</a> to edit meta keywords.<span style="float:right;">(SEO) <input style="width:150px;" readonly value="seo_blog_meta_keywords"></span></info>',
