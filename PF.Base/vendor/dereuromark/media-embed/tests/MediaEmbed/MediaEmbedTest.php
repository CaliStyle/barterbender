...
class MediaEmbedTest extends TestCase {
	...
	protected $_stubs = [
		...
		'https://www.youtube.com/watch?v=yiSjHJnc9CY&feature=feedrec_grec_index' => 'yiSjHJnc9CY',
		...
		// more difficult
		//'https://www.youtube.com/user/AttilaHildmannTV#p/c/D0F9D267C03BF7BE/0/hHCnY3RwxMM' => 'hHCnY3RwxMM',
		'https://www.youtube.com/watch?v=-vGzem8glbE&feature=channel' => '-vGzem8glbE',
	...
	public function testParseUrlInvalid() {
		$MediaEmbed = new MediaEmbed();
		$result = $MediaEmbed->parseUrl('https://www.youtube.com/foobar');
