...
class MediaEmbed {
	...
	public $availableTypes = [
		'youtube' => [
			...
			'swf' => 'https://www.youtube.com/v/{id}',
			'url' => 'https://www.youtube.com/watch?v={id}&t={t}',
		],
		'google' => [
		],
		'myvideo' => [
	...
	public $availableNonJSTypes = [
		'youtube' => '<iframe src="https://www.youtube.com/embed/{id}" width="100%" height="385" frameborder="0"></iframe>',
