...
class Phpfox
{
    ...
    {
        static $sUserOffSet, $aReplaceDay, $aReplaceMonth, $aReplaceDayShort, $aReplaceMonthShort;
        $iNewTime = '';
    ...
    public static function run()
    {
        ...
        if (!self::isAdminPanel()) {
            ...
            $oTpl->assign([
                    ...
                    'sFullControllerName' => str_replace(['.', '/'], '_',
                        Phpfox_Module::instance()->getFullControllerName()),
