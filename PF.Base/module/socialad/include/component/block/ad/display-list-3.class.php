...
class Socialad_Component_Block_Ad_Display_List_3 extends Phpfox_Component
{
	...
	public function process()
	{
        ...
        if(Phpfox::getService('socialad.session')->shouldShowHtml()) {
            $aHtmlAds = Phpfox::getService('socialad.ad')->getToDisplayOnBlock([
                'user_id' => Phpfox::getUserId(),
                'block_id' => 3,
                'module_id' => $sSaModuleId,
                'html' => true,
                'limit' => Phpfox::getParam('socialad.maxium_number_of_html_ads')
            ]);
        }
        ...
        if(!count($aHtmlAds) && !count($aBannerAds)){
            return false;
        }
