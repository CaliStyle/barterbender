 ...
 */
class Resume_Component_Block_Privacy_Form extends Phpfox_Component
{
	/**
	...
	{		
		...
		$aPrivacyControls[] = array(
			'phrase' => _p('resume.job_seeker_group'),
			'value' => '1'
		);
		...
		if (Phpfox::isModule('friend') && !(bool) $this->getParam('privacy_no_custom', false))
		{
			...
			$aPrivacyControls[] = array(
				'phrase' => _p('privacy.custom_span_click_to_edit_span'),
				'value' => '4',
