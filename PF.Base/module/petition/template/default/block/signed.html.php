...
{foreach from=$aSigned key=iKey item=aPetition name=Signed}
<div class="view_content_listing{if $iKey == count($aSigned)-1} last {/if}">
...
<div class="clear"></div>
{if $iTotal > 4}
<div class="block_viewmore text-center"><a class="btn btn-success btn-sm" href="{url link='petition' status='0' view='listing' sort='most-signed'}">{phrase var='petition.view_all'}</a></div>
{/if}
</div>
