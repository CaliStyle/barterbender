...
<div class="panel panel-default">
    ...
    {if count($aGroups)}
    <form method="post" action="{url link='admincp.ecommerce.customfield'}">
        <div class="panel-body">
            <div id="js_menu_drop_down" style="display:none;">
                <div class="link_menu dropContent" style="display:block;">
                    <ul>
                        <li><a href="#" onclick="return $Core.ecommerce_customgroup.action(this, 'edit');">{phrase var='edit'}</a></li>
                        <li><a href="#active" onclick="return $Core.ecommerce_customgroup.action(this, 'active');">{phrase var='set_to_inactive'}</a></li>
                        <li><a href="#" onclick="return $Core.ecommerce_customgroup.action(this, 'delete');">{phrase var='delete'}</a></li>
                    </ul>
                </div>
            </div>
            <div>
    ...
    <div class="alert alert-info">
        ...
        <a href="{url link='admincp.ecommerce.customfield.add'}">{phrase var='add_a_new_custom_group'}</a>
    </div>
    {/if}
</div>