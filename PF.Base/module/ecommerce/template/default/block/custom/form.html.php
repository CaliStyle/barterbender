        ...
        <div class="table form-group">
            ...
            <div class="table_right">
                ...
                {elseif $aField.var_type=='checkbox'}
                    {foreach from=$aField.option key=opId item=opPhrase}
                        <div class="checkbox">
						<label for="js_jp_cf_{$aField.field_id}">		
							<input {if $aField.is_required==1}data-isrequired="1"{else}data-isrequired="0"{/if} data-type="checkbox" id="js_jp_cf_{$aField.field_id}" type="checkbox" name="val[custom][{$aField.field_id}][]" value="{$opId}" 
                        {if isset($aField.value)}
