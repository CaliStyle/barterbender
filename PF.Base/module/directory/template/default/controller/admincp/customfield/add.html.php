...
<form method="post" id="js_add_group_name_form" name="js_add_group_name_form" >
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="group_name">{required}{phrase var='group_name'}</label>
            ...
            {if !empty($bIsEditGroup)}
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="t_center w220">
                                <a href="javascript:void(0)" onclick="tb_show('', $.ajaxBox('directory.AdminAddCustomFieldBackEnd', 'height=300&amp;width=300&action=edit&id={$iField.field_id}'))">{phrase var='edit'}</a>
                                /
                                <a href="{$sUrlAdd}id_{$aGroup.group_id}/delete_{$iField.field_id}" class="sJsConfirm">{phrase var='delete'}</a>
                            </td>
                        </tr>
                        {/foreach}
                    </table>
                ...
                <div class="js_mp_parent_holder" id="js_mp_holder">
                    {if isset($bIsEditGroup) && $bIsEditGroup}
                        <a href="javascript:void(0)" onclick="tb_show('', $.ajaxBox('directory.AdminAddCustomFieldBackEnd', 'height=300&width=300&action=add&iGroupId={$aGroup.group_id}')); return false;">{phrase var='add_custom_field'}</a>
                    {/if}
                </div>
            {/if}
        </div>
