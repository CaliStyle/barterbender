    ...
    <div class="item-outer">
            ...
            <a href="{$aListing.url}" class="mp_listing_image"
               style="background-image: url(
                {if !empty($aListing.image_path)}
                    {img server_id=$aListing.server_id title=$aListing.title path='core.url_pic' file='advancedmarketplace/'.$aListing.image_path  suffix='_400_square' return_url=true}
                {else}
        ...
        <div class="item-inner">
            ...
            <div class="item-statistic">
                <span>
                    <span class="count">{$aListing.total_like}</span>
                    {if $aListing.total_like == 1}{_p var='like__l'}{else}{_p var='likes__l'}{/if}
                </span>
                <span>&nbsp;.&nbsp;</span>
                <span>
                    <span class="count">{$aListing.total_view}</span>
