...
class Directory_Component_Controller_Admincp_Customfield_Add_Field extends Phpfox_Component
{
    /**
    ...
    public function process()
    {
        ...
        elseif($sAction == 'edit')
        {
            ...
            $aField = Phpfox::getService('directory.custom')->getForCustomEdit($iId);
