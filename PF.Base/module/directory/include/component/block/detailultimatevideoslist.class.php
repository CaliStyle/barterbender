...
class Directory_Component_Block_detailultimatevideoslist extends Phpfox_Component {
	...
	public function process() {
		...
		$aVideos = array();
		$iCountVideos = 0;
		list($aVideos, $iCountVideos) = Phpfox::getService('directory')->getUltimateVideoByBusinessId($aBusiness['business_id'], $aConds, $aExtra, true);				
		...
		{	
            ...
            Phpfox::getService('directory')->convertImagePath($aVideos[$iKey], 500);
		}
