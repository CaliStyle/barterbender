...
class Directory_Component_Block_detailultimatevideos extends Phpfox_Component {
	...
	public function process() {
		...
		$bCanViewVideoInBusiness = Phpfox::getService('directory.permission')->canViewVideoInBusiness($aYnDirectoryDetail['aBusiness']['business_id'], $bRedirect = false,null,null,null,true);
		...
		$bCanAddVideoInBusiness = Phpfox::getService('directory.permission')->canAddVideoInBusiness($aYnDirectoryDetail['aBusiness']['business_id'], $bRedirect = false,null,true);
