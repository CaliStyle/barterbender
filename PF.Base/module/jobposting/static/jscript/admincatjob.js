...
$Core.jobposting =
{
	...
	action: function(oObj, sAction)
	{
		...
		{
			case 'edit':
				window.location.href = this.sUrlAdd + '/id_' + aParams['id'] + '/';
				break;
			case 'delete':
				if (confirm(oTranslations['jobposting.are_you_sure_this_will_delete_all_items_that_belong_to_this_category_and_cannot_be_undone']))
				{
