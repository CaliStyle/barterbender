...
class Readability
{
	...
	**/
	public $regexps = array(
		'unlikelyCandidates' => '/combx|comment|community|disqus|extra|foot|header|menu|remark|rss|shoutbox|sidebar|sponsor|ad-break|agegate|pagination|pager|popup|tweet|twitter|date|bookmark|video|embedded|edp|feature|byline|hidden|button|slide|tag|enlargeicon|zoom/i',
		'okMaybeItsACandidate' => '/and|hidden|article|body|column|main|shadow|txt/i',
		'positive' => '/article|body|content|entry|hentry|main|page|pagination|post|text|blog|story|table/i',
		'negative' => '/combx|hidden|comment|com-|contact|foot|footer|footnote|masthead|media|meta|outbrain|promo|related|scroll|shoutbox|sidebar|sponsor|shopping|tags|tool|widget|expand|strycntntrgt|enlarge/i',
	...
	* @param string $html,$url UTF-8 encoded string
	...
	*/	
	function __construct($html, $url=null)
	{
		...
		if (mb_detect_encoding($html, "UTF-8, ASCII, ISO-8859-1") == 'UTF-8')
		{
