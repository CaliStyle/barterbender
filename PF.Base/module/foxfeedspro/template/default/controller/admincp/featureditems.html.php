...
<form method="post" action="{url link='admincp.foxfeedspro.featureditems'}">
                        ...
                        <table table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr id="foxfeedspro_item_{$aNews.item_id}" class="news_row {if $iKey%2 == 0 } feed_row_even_background{else} feed_row_odd_background{/if}">
                                    ...
                                    <!-- News title -->
                                    <td>
                                        <a href="{url link='foxfeedspro.newsdetails.item_'.$aNews.item_id}" title="{$aNews.item_title}">{$aNews.item_title|shorten:35:'...'}</a>
                                    </td>
                                    <!-- RSS provider name -->
                                    <td class="t_center">
