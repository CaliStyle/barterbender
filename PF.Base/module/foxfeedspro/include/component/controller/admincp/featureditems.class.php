 ...
 *
 */
class FoxFeedsPro_Component_Controller_Admincp_FeaturedItems extends Phpfox_Component 
{
	/*
	...
	public function process() 
	{
		...
		if($sReset)
		{
			$this-> url()->send('admincp.foxfeedspro.featureditems');
		}
		...
		// Set BreadCrumb
		$sUrl = $this -> url() -> makeurl('admincp.foxfeedspro.featureditems');
		$this -> template() -> setBreadCrumb(_p('foxfeedspro.featured_news_management'), $sUrl);
