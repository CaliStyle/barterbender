 ...
 */
 ...
 Class FoxFeedsPro_Component_Block_Top_News extends Phpfox_Component
 {
 	/*
 	...
 	public function process()
	{
		...
		$iLimit 		= Phpfox::getParam('foxfeedspro.number_top_news');
		...
		$this->template()->assign(array(
				'sHeader'  		 => _p('foxfeedspro.top_news'),
                ...
                'aFooter' => array(
                    _p('view_all') => $this->url()->makeUrl('foxfeedspro.sort_most-viewed')
                ),
			)
		);
		return 'block';
