 ...
 */
 ...
 Class FoxFeedsPro_Component_Block_Commented_News extends Phpfox_Component
 {
 	/*
 	...
 	public function process()
	{
		...
		$iLimit 		= Phpfox::getParam('foxfeedspro.number_commented_news');
		...
		$this->template()->assign(array(
				'sHeader'  		 => _p('foxfeedspro.most_discussed'),
                ...
                'aFooter' => array(
                    _p('view_all') => $this->url()->makeUrl('foxfeedspro.sort_most-comment')
                ),
			)
		);
		return 'block';
