...
class Opensocialconnect_Component_Block_ViewloginHeaderVisitor extends Phpfox_Component
{
    public function process()
    {
        ...
        $iMarginLeft = intval(Phpfox::getParam('opensocialconnect.margin_left'));
