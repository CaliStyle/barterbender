...
<form method="post" enctype="multipart/form-data" action="" id="core_js_blog_form">
    <div class="panel panel-default">
        <div class="panel-heading" >
            {if $isEdit}{phrase var='gettingstarted.edit_a_new_todo_list'}{else}{phrase var='gettingstarted.add_a_new_todo_list'}{/if}
        </div>
        <div class="panel-body">
            <div class="form-group">
                ...
                <select id="language_id" name="val[language_id]" class="form-control">
                    {foreach from=$aLanguages item=aLanguage}
                    <option value="{$aLanguage.language_id}" {if isset($aForms.language_id)} {if $aForms.language_id == $aLanguage.language_id}selected{/if}{/if}>{$aLanguage.title}</option>
                    {/foreach}
                </select>
            ...
            <div class="form-group">
                ...
                <input id="title_inner" class="form-control" type="text" name="val[title]" size="50" value="{value type='input' id='title'}" ></input>
            </div>
            <div class="form-group">
                <label>
        ...
        <div class="panel-footer">
            <input type="submit" id="submit_addarticlecategory"name="submit_addtodolist" value="{phrase var='core.submit'}" class="btn btn-primary" />
        </div>
    </div>
</form>