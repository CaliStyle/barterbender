    ...
    scribd.Document.prototype = {
        ...
        write : function(elementId) {
			...
			if (window.location.protocol == "https:") {
            	var srcPath = oParams.sJsHome+"module/document/static/";
            }
...
var Scribd_AC_RunActiveContent = new function()
{
    ...
    /* ------------------------
        ...
        Implied consent for use: https://www.adobe.com/devnet/activecontent/articles/devletter.html
