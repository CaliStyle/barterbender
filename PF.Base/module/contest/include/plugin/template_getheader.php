...
if(Phpfox::getLib('request')->getRequests() == [
    ...
    Phpfox::getLib('url')->send('admincp.setting.edit', ['module-id' => 'contest']);
}
if (Phpfox::getLib('request')->getRequests() == [
        'req1' => 'admincp',
        'req2' => 'contest',
    ...
    Phpfox::getLib('url')->send('admincp.user.group.add', ['setting' => 1, 'hide_app' => 1, 'module' => 'contest','group_id' => 2]);
}
...
if (Phpfox::getLib('request')->get('req1') == 'admincp'
    ...
    && Phpfox::getLib('request')->get('module') == 'contest'
