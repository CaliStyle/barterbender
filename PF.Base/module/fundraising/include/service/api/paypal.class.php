 ...
 */
class Fundraising_Service_Api_Paypal implements Fundraising_gatewayinterface {
	...
	public function getEditForm() {
		return array(
			'paypal_email' => array(
				'phrase' => _p('core.paypal_email'),
				'phrase_info' => _p('core.the_email_that_represents_your_paypal_account'),
	...
	public function getForm() {
		...
		$aForm = array(
			...
			'param' => array(
				...
				'notify_url' => Phpfox::getService('fundraising.gateways')->url('paypal'),
