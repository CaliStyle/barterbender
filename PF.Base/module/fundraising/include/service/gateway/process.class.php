 ...
 */
class Fundraising_Service_Gateway_Process extends Phpfox_Service 
{
	/**
	 * Class constructor
	 */	
	...
	{
		$this->database()->insert(Phpfox::getT('fundraising_gateway_log'), array(
				'gateway_id' => $sGateway,
	...
	public function __call($sMethod, $aArguments)
	{
		 ...
		 */
		if ($sPlugin = Phpfox_Plugin::get('fundraising.service_gateway_process__call'))
		{
			return eval($sPlugin);
		}
