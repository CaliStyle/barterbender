 ...
 * @version        3.01
 */
class Coupon_Service_FAQ_Process extends Phpfox_Service
{
        ...
        public function updateOrder($aVals)
        {
                ...
                $this->cache()->remove('coupon_faq_display_admincp_' . Phpfox::getLib('locale')->getLangId());
        ...
        public function __call($sMethod, $aArguments)
        {
                 ...
                 */
                if ($sPlugin = Phpfox_Plugin::get('coupon.service_faq_process__call'))
                {
                        return eval($sPlugin);
                }
