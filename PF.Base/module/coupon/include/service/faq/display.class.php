 ...
 */
class Coupon_Service_FAQ_Display extends Phpfox_Service
{

        protected $_sTable;
        protected $_module = 'coupon';              //name of module
        protected $_col_name = 'question';              //name of column 'category name'
        protected $_col_id = 'faq_id';         //name of column 'category id'
        protected $_col_parent_id = 'parent_id';    //name of column 'parent category id'
        protected $_cache_key = 'coupon_faq';
        ...
        protected function _renderItem($aItems, &$sHtml, $css = null)
        {
                ...
                foreach ($aItems as $aItem)
                {
                        ...
                        $url = Phpfox::getLib('url')->makeUrl($this->_module . '.faq', array($aItem[$this->_col_id], $name_url, 'when_upcoming'));
