...
class Auction_Service_Mail_Send extends Phpfox_Service 
{
    ...
    {
        $this->_sTable = Phpfox::getT('auction_email_queue');
    }
	...
	{
		if(!Phpfox::getService('auction.mail.phpfoxmail')->to($aReceivers)		
				->subject($sSubject)
				->message($sMessage)
				->send())
		{
