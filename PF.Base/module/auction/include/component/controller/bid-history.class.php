...
class Auction_Component_Controller_Bid_History extends Phpfox_Component
{
	...
	public function process()
	{
        ...
        $this->template()->setBreadcrumb(_p('bid_history'), $this->url()->permalink('auction.bid-history','id_'.$iProductId),true);
