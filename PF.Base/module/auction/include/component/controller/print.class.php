...
class Auction_Component_Controller_Print extends Phpfox_Component
{
	public function process()
	{
		...
		if ($aAuction['module_id'] == 'pages' && !Phpfox::getService('pages')->hasPerm($aAuction['item_id'], 'auction.view_browse_auction'))
		{
		...
		$this->template()
                ...
                ->setBreadCrumb(Phpfox::getLib('locale')->convert($aAuction['category_title']), $this->url()->permalink('auction.category', $aAuction['category_id'], ''))
                ->setBreadCrumb($aAuction['name'], $this->url()->permalink('auction.detail', $aAuction['product_id'], $aAuction['name']))
                ->setBreadCrumb('', '', true);
        ...
        $this->template()->setEditor(array(
                ...
                ->setHeader('cache', array(
                    ...
                    'jquery.countdown.css' => 'module_auction',
                    ...
                    'masterslider.css'=> 'module_auction',
                    'masterslider-style.css'=> 'module_auction',
                        )
        );
