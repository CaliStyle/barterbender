...
?>
<div id="auctions_buyers_also_viewed" class="">
    <ul>
        {foreach from=$aBuyersAlsoViewedAuctions item=aAuction}
            <li>
...
<!--                        <span class="auction_user_icon"></span> -->
                        {phrase var='by'} <a href="{url link=$aAuction.user_name}" title="{$aAuction.full_name|clean}">{$aAuction.full_name|clean|shorten:25:'...'|split:25}</a>
                    </div>
    ...
    {if $bShowViewMoreAuctionsBuyersAlsoViewed}
        <div class="auction_view_more">
            <a href="{url link='auction' view='buyers-also-viewed'}" class="btn btn-sm btn-success" title="{phrase var='view_more'}">
