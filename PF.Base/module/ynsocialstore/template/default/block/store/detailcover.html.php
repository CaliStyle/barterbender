...
<div class="ynstore-store-detail-block">
    ...
    <div class="ynstore-actions-social">
        <div class="ynstore-embedcode dropdown">
            <a data-caption="HTML Code" title="HTML Code" class="btn btn-default" onclick="$(this).parent('div').toggleClass('open'); if($('.ynstore_store_html_code_block textarea').length){l} $('.ynstore_store_html_code_block textarea').get(0).select();{r}">
