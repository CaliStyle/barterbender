...
class Ynsocialstore_Component_Block_Store_PhotoGallery extends Phpfox_Component
{
    public function process()
    {
        ...
        $this->template()->assign(array(
            ...
            'aRandomPhoto' => Phpfox::getService('ynsocialstore')->getRandomPhotoForAllPhoto($iStoreId),
        ));
    }
}