    ...
    public function process()
    {
        ...
        if ($provider_name)
        {
            if ($this->request()->get('edit') == _p('core.submit'))
            {
                ...
                $this->url()->send('admincp.contactimporter.providers', null, _p('the_infomation_of_provider_name_provider_was_updated_successfully',array('provider_name'=>$provider_name)));
            }
        ...
        {
            $this->url()->send('admincp.contactimporter.providers', null, _p('you_must_select_provider_to_edit'));
