...
<div class="table_header">
	{_p var='contact_providers_edit'}
</div>
<div class="table">
	<div class="table_left">
		{_p var='contact_providers_name'}:
	</div>
...
<div class="table">
	<div class="table_left">
		{_p var='contact_providers_title'}:
	</div>
	<div class="table_right">
...
<div class="table">
	<div class="table_left">
		{_p var='admincp_providers_order'}:
	</div>
	<div class="table_right">
...
<div class="table">
	<div class="table_left">
		{_p var='contact_providers_active'}:
	</div>
	<div class="table_right">
