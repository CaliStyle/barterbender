...
class Videochannel_Component_Block_Suggestions extends Phpfox_Component
{
    ...
    public function process()
    {
        ...
        list(,$aVideos) = $this->getServiceVideochannel()->getRelatedVideosSuggestions($aVideo['video_id'], $aVideo['title'], true, false, $iCategoryId);
        ...
        $arAssign = array(
            'sHeader' => _p('videochannel.suggestions'),
