 ...
 */
class Videochannel_Service_Channel_Feedprocess extends Phpfox_Service 
{	
	...
	{	
		...
		// Set default for parent user id.
	...
	{		
		...
		{			
			// $this->cache()->remove('feed_' . $aFeed['user_id']);
			if ($iUser != false)
			{
