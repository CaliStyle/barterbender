			...
			{foreach from=$aMyVideos name=minivideos item=aMiniVideo}
				...
				<div class="view_user_more_item" style="left:{$iLeft}px; height:180px;">					
					<div style="width:90px;">
						<a href="{$aMiniVideo.link}">{img server_id=$aMiniVideo.image_server_id path='core.url_pic' file=$aMiniVideo.image_path suffix='_120' max_width=90 max_height=70 class='js_mp_fix_width' title=$aMiniVideo.title}</a>
						<div>
