        ...
        JHSlide : function (/* PARAMS */slideTime, transition) {
            ...
            var setupSliderItemImage = function(/*&*/slider, childGroup) {
                ...
                bimg.each(function(/*index*/){
                    var $this = $(this);
					$this.attr('video_link', $this.parent().parent().find('.jhslider-info-detail a').attr('href'));
					...
					$this.css({
						...
						window.location = $this.attr("video_link");
						console.log($this);
						return false;
					});
                });
            ...
            var setupAllSize = function(divsColl, itemCount) {
                ...
                var container_width = $('#yn_slide_show_block').width();
                $('.jhslider-slider-li').css('width',container_width + 'px');

                divsColl["slider"].width((1 + itemCount) * container_width/* itemWidth */);
				if(itemHeight > 0) {
					divsColl["slider"].height(itemHeight);
				}

                return {
                    "width": container_width/* itemWidth */,
                    "height": 276/* itemHeight */
                };
            };
