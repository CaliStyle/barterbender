	...
	<div class="profile-info-block">
		...
		<div class="profile-info">
			...
			<div class="profile-actions">
				{if Phpfox::getUserId() == $aUser.user_id}
                <a class="btn btn-default btn-icon " role="link" href="{url link='user.profile'}">
				...
				<div class="profile-action-block profile-viewer-actions dropdown">
					{if Phpfox::isUser() && Phpfox::isModule('friend') && !$aUser.is_friend && $aUser.is_friend_request !== 2}
                        ...
                        <a class="btn btn-primary btn-icon btn-gradient add_as_friend_button" href="#" onclick="return $Core.addAsFriend('{$aUser.user_id}');" title="{_p var='add_to_friends'}">
					...
					{if Phpfox::isModule('mail') && User_Service_Privacy_Privacy::instance()->hasAccess('' . $aUser.user_id . '', 'mail.send_message')}
                        <a class="btn btn-default btn-icon " href="#" onclick="$Core.composeMessage({left_curly}user_id: {$aUser.user_id}{right_curly}); return false;">
                    ...
                    <div class="dropup btn-group">
                        <a class="btn btn-default" title="{_p var='more'}" data-toggle="dropdown" role="button">
...
<div class="profiles-menu set_to_fixed" data-class="profile_menu_is_fixed">
	<ul>
		...
		<li>
			<a href="{url link=$aUser.user_name}" class="profile-menu-timeline-js">
				<span class="ico ico-alignleft"></span>
				{_p var='timeline'}
			</a>
		</li>
		<li>
			<a href="{url link=''$aUser.user_name'.info'}" class="profile-menu-info-js">
        ...
        {if Phpfox::isModule('friend')}
		    <li class="hidden-xs">
				<a href="{url link=''$aUser.user_name'.friend'}" class="profile-menu-friend-js">
				...
				{foreach from=$aProfileLinks item=aProfileLink}
					<li class="">
						<a href="{url link=$aProfileLink.url}" class="ajax_link {if isset($aProfileLink.is_selected)} active{/if}">
							<span class="yncfbclone-profile-menu-app">
