...
{/if}
    ...
    <div class="table_hover_action hidden">
        ...
        <input type="submit" name="ban" value="{_p var='ban'}" class="sJsConfirm btn btn-default sJsCheckBoxButton disabled" disabled="disabled" />
        <input type="submit" name="unban" value="{_p var='un_ban'}" class="btn btn-default sJsCheckBoxButton disabled" disabled="disabled" />
        ...
        <input type="submit" name="delete" value="{_p var='delete'}" class="sJsConfirm btn btn-danger sJsCheckBoxButton disabled" disabled="disabled" />
        {/if}
    </div>
	</form>
</div>
