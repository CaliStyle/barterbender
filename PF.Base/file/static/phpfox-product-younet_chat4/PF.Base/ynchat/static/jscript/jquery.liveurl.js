...
(function( $ )
{
    ...
    { 
        liveUrl : function( options) 
        {
            var defaults = 
            {
               ...
               imgLoadEnd       : function() {},
               addImage         : function() {},
               subKeyUp         : function(e, ele) {},
               subPaste         : function(e, ele) {}
            }
            ...
            this.each(function() 
            {
                ...
                core.getPreview = function(data, uri)
                {
                    ...
                    // prepare output
                    var not   = 'undefined';
                    // lytk: we should not use dataPreview, just put original data from embed.ly
                    var dataPreview  = {
                        title       : preview.title,
    ...
    jsynchat.yql = function yql(query, error, success, url, apiKeyEmbedly)
    {
        var deferred = $.embedly.extract([url], {
          key: apiKeyEmbedly,
          query: {
//            words: 50,
//            /*videosrc: true,*/
