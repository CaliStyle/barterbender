	...
	<article>
			<div class="item-outer flex">
				...
				<div class="item-inner overflow">
                    ...
                    <div class="item-category"><a class="js_hover_title" href="{url link='marketplace' location=$aListing.country_iso}">
                            {$aListing.country_iso|location}
                            <span class="js_hover_info">
                                {$aListing.location}
                            </span>
                        </a>&nbsp;.&nbsp;<span>{_p var='category'}: {$aListing.categories|category_links|shorten:64:'...'}</span>
					</div>
