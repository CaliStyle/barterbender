...
namespace Apps\YNC_Feed\Controller\Photo;
...
class Frame extends Phpfox_Component
{
            ...
            if ($sError == UPLOAD_ERR_OK) {
                if ($aImage = $oFile->load('image[' . $iKey . ']', array(
                    ...
                    if (isset($aVals['page_id'])) {
                        ...
                        $aVals['group_id'] = $aVals['page_id'];
                    }

                    if (isset($aVals['groups_id'])) {
                        $aVals['callback_module'] = 'groups';
                        $aVals['group_id'] = $aVals['groups_id'];
                    }
