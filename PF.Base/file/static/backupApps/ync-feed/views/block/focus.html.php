...
<div class="activity_feed_content_text{if isset($aFeed.comment_type_id) && $aFeed.comment_type_id == 'poll'} js_parent_module_feed_{$aFeed.comment_type_id}{/if}{if Phpfox::isAppActive('P_StatusBg') && !empty($aFeed.status_background)} p-statusbg-feed" style="background-image: url('{$aFeed.status_background}');"{else}"{/if}>
    ...
    <!-- don't breakline (issue layout) -->
    <div class="activity_feed_content_status">{if strpos($aFeed.feed_status, '<br/>') >= 200}
        {$aFeed.feed_status|ynfeed_strip|shorten:200:'feed.view_more':true|split:55|max_line}
        {else}
        {$aFeed.feed_status|ynfeed_strip|split:55|max_line|shorten:200:'feed.view_more':true}
        {/if}
    </div>
    {/if}
    ...
    isset($aFeed.location_name) && isset($aFeed.location_latlng.latitude) && empty($aFeed.status_background)}
            ...
            <div class="ynfeed_business_info">
               ...
               <div class="ynfeed_business_categories_location">
                  <span class="ynfeed_business_categories">
                     {_p var=$aFeed.aBusiness.category_title}
                  </span>
    ...
    <div class="activity_feed_content_link">
        ...
        <div class="activity_feed_content_image" {if isset($aFeed.feed_custom_width)}
             style="width:{$aFeed.feed_custom_width};" {/if}>
    ...
    <div class="feed_banner">
        ...
        <div
            ...
            {if isset($aFeed.feed_custom_width)} style="margin-left:{$aFeed.feed_custom_width};" {/if}>
