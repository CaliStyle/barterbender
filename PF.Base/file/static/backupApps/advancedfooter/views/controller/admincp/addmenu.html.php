...
<div class="panel panel-default">
    <div class="panel-body">
        <form method="post"  enctype="multipart/form-data" action="{url link='admincp.advancedfooter.addmenu'}" onsubmit="$Core.onSubmitForm(this, true);">
        {if $bIsEdit}
        ...
        <div class="table form-group">
            <div class="table_left">
                {_p var='Phpfox Page Link'}: (example: event, marketplace, profile.my and etc)
            </div>
        ...
        <div class="table form-group">
            <div class="table_left">
                {_p var='Full page link'}: (example: https://facebook.com)
            </div>
            <div class="table_right">
                <input class="form-control" name="val[direct_link]" value="{if !empty($aForms.direct_link)}{$aForms.direct_link}{/if}" type="text" />
            </div>
            <div class="clear"></div>
        </div>
        <div class="form-group">
