...
<div class="table-responsive panel panel-default groups-manage-categories">
    ...
    <table class="table table-admin" id="_sort" data-sort-url="{if $bSubCategory}{url link='groups.admincp.category.order' type='sub'}{else}{url link='groups.admincp.category.order' type='main'}{/if}">
        <tr>
            <th class="w20"></th>
            <th class="w20"></th>
            <th>{_p('Name')}</th>
