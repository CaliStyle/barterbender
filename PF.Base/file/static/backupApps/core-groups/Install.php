    ...
    public function setSettings()
    {
        $this->settings = [
            ...
            'groups_setting_meta_description' => [
                ...
                'description' => 'Meta description added to groups related to the Groups app. <a role="button" onclick="$Core.editMeta(\'groups_meta_description\', true)">Click here</a> to edit meta description.<span style="float:right;">(SEO) <input style="width:150px;" readonly value="groups_meta_description"></span>',
                'type' => '',
                'value' => '',
                'ordering' => 5,
                'group_id' => 'seo'
            ...
            'groups_setting_meta_keywords' => [
                ...
                'description' => 'Meta keywords that will be displayed on sections related to the Groups app. <a role="button" onclick="$Core.editMeta(\'groups_meta_keywords\', true)">Click here</a> to edit meta keywords.<span style="float:right;">(SEO) <input style="width:150px;" readonly value="groups_meta_keywords"></span>',
                'type' => '',
                'value' => '',
                'ordering' => 6,
                'group_id' => 'seo'
