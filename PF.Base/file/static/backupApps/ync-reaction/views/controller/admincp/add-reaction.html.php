...
{literal}
<style type="text/css">
    #ync_reaction_add_reaction ._colorpicker_holder {
        position: inherit;
        width: 64px;
        height: 32px;
...
{/literal}
<form action="{url link='current'}" enctype="multipart/form-data" method="post" id="ync_reaction_add_reaction" onsubmit="$Core.onSubmitForm(this, true);">
    {if $bIsEdit}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-footer">
            ...
            <a class="btn btn-default" href="{url link='admincp.app' id='YNC_Reaction'}">{_p var='back'}</a>
        </div>
    </div>
</form>
