...
?>
<div class="ync-comment-item {if !empty($iParentId)}ync-comment-item-reply{/if} ync-comment-item-hide" id="js_hide_comment_{$iCommentId}">
        ...
        <div class="item-inner">
            ...
            <div class="item-action">
                <div class="action-list">
                    <span class="total-like"><a href="#" onclick="return ynccomment.hideComment(this, true);" data-comment-id="{$iCommentId}">{_p var='unhide'}</a></span>
