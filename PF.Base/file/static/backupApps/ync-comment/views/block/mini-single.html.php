...
{if $aComment.parent_id}
    <div id="js_comment_{$aComment.parent_id}" class="js_mini_feed_comment ync-comment-item js_mini_comment_item_{$aComment.item_id}" style="padding-top: 0;padding-bottom: 0;">
