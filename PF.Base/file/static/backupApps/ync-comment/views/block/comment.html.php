                                ...
                                <div id="js_feed_comment_post_{$aFeed.feed_id}" class="js_feed_comment_view_more_holder">
                                    {if isset($aFeed.comments) && $iShownTotal = count($aFeed.comments)}
                                            ...
                                            <div class="ync-comment-container">
                                                <div id="js_feed_comment_view_more_{$aFeed.feed_id}"{if isset($sFeedType) &&  $sFeedType == 'view'}class="js_ync_comment_comment_items"{else} class="js_ync_comment_limit js_ync_comment_comment_items" data-limit="{if ($thisLimit = setting('ynccomment_comment_show_on_activity_feeds'))}{$thisLimit}{/if}"{/if}>
                                                    {foreach from=$aFeed.comments name=comments item=aComment}
                                                        {template file='ynccomment.block.mini'}
                                                    {/foreach}
