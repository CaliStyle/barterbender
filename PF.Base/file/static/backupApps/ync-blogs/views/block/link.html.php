...
<li>
    <a title="{_p('Favorite')}" class="favorite" onclick="$(this).parents('li.ynadvblog_item').remove(); ynadvancedblog.updateFavorite({$aItem.blog_id},0);">
        <i class="fa fa-star"></i> {_p var='Un-Favorite'}
    </a>
</li>
{/if}
