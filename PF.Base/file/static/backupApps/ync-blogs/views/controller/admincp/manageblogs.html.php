...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form class="ynab_blog_search_form" method="post" onsubmit="return ynadvancedblog_manage.getSearchData(this, 'adminManage');">
            <!-- Coupon Name-->
                    ...
                    <tbody>
                        {foreach from=$aList key=iKey item=aItem}
                            <tr id="js_row{$aItem.blog_id}" class="checkRow{if is_int($iKey/2)} tr{else}{/if}">
                                ...
                                <td class="on_off w80">
                                    {if $aItem.canFeature && $aItem.module_id == 'ynblog'}
