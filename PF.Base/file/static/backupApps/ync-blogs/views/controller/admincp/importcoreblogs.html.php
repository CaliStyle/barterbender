...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form class="ynab_blog_search_form" method="post" onsubmit="return ynadvancedblog_manage.getSearchData(this, 'adminImport');">
            <!-- Coupon Name-->
            ...
            <!-- Submit Buttons -->
            <div class="form-group">
                <input type="submit" id="ynab_filter_blog_submit" name="search[submit]" value="{_p('Search')}" class="btn btn-primary"/>
            </div>
        </form>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="panel-footer t_right">
            ...
            <input type="submit" name="val[import_selected]" id="import_selected" disabled value="{_p('Import Selected')}" class="sJsCheckBoxButton delete_selected btn btn-primary disabled" onclick="ynadvancedblog_manage.chooseCategoryInAdmin(this, 0); return false;"/>
        </div>
    </div>
</form>
{else}
