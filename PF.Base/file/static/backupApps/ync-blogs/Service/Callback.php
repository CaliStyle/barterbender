...
class Callback extends Phpfox_Service
{
    ...
    public function processCommentModeration($sAction, $iId)
    {
        ...
        if ($sAction == 'approve') {
            ...
            if (Phpfox::getParam('core.is_personal_site')) {
                $sLink = Phpfox::getLib('url')->makeUrl('ynblog', $aBlog['title_url']);
            } else {
    ...
    public function getSearchInfo($aRow)
    {
        ...
        $aInfo['item_display_photo'] = '<img style="" src="' . Phpfox::getService('ynblog.helper')->getImagePath($aRow['item_photo'], $aRow['item_photo_server'], '_grid') . '" class="_image_120 image_deferred  built has_image">';
        return $aInfo;
    }
    ...
    public function getActivityFeed($aItem, $aCallback = null, $bIsChildItem = false)
    {
        ...
        $aRow = $this->database()->select('b.user_id, b.blog_id, b.title, b.time_stamp, b.total_comment, b.privacy, b.total_like, b.text, b.module_id, b.item_id, b.image_path, b.server_id')
        ...
        $aReturn = array(
            ...
            'feed_info' => _p('wrote_a_ynblog_entry'),
    ...
    public function getPageMenu($aPage)
    {
        ...
        $aMenus[] = [
            ...
            'url' => Phpfox::getService('pages')
                    ->getUrl($aPage['page_id'], $aPage['title'], $aPage['vanity_url']) . 'advanced-blog/',
    ...
    {
        if (!Core\Lib::appsGroup()->hasPerm($aPage['page_id'], 'ynblog.view_browse_blogs')) {
            return null;
        }

        $aMenus[] = [
            'phrase' => _p('ynblog'),
            'url' => Core\Lib::appsGroup()->getUrl($aPage['page_id'], $aPage['title'], $aPage['vanity_url']) . 'advanced-blog/',
            'icon' => 'module/blog.png',
            'landing' => 'ynblog'
        ];
    ...
    {
        if (!Core\Lib::appsGroup()->hasPerm($aPage['page_id'], 'ynblog.share_ynblogs')) {
            return null;
        }
    ...
    public function getUploadParams() {
        return [
            'upload_url' => Phpfox::getLib('url')->makeUrl('ynblog.frame-upload'),
            'label' => '*'._p('main_photo'),
            'max_size' => null,
