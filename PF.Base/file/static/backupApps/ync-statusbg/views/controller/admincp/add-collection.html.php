...
<form action="{url link='admincp.yncstatusbg.add-collection'}" method="post" id="js_collection_form" class="yncstatusbg-acp-collection">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group" style="max-width: 200px; {if $bIsEdit && $aForms.is_default}opacity: 0.5;pointer-events: none;{/if}">
                ...
                <div class="item_is_active_holder" id="js_ync_status_is_default">
            ...
            <div class="help-block" id="js_ync_status_is_default_help" style="color: red; {if !isset($aForms) || !$aForms.is_default || ($bIsEdit && $aForms.is_default)}display: none;{/if}">
                {_p var='if_set_as_default_this_collection_is_activated_and_the_current_default_one_will_be_set_inactive'}
            </div>
            <div class="form-group" style="max-width: 200px; {if $bIsEdit && $aForms.is_default}opacity: 0.5;pointer-events: none;{/if}">
                <label for="is_active">{_p var='active__u'}</label>
                <div class="item_is_active_holder" id="js_ync_status_is_active">
                    <span class="js_item_active item_is_active">
            ...
            <div class="help-block" id="js_ync_status_is_active_help" style="color: red; display: none;">
            ...
            {if !isset($aForms) || !$aForms.view_id}
                <div class="form-group" style="border:1px solid #eee;padding: 8px;">
                    ...
                    {module name='core.upload-form' type='yncstatusbg' params=$aForms.params}
                </div>
            {/if}
            <div id="js_list_backgrounds">
                {template file='yncstatusbg.block.admin.list-backgrounds'}
            </div>
            <div class="help-block">
                {if !isset($aForms) || !$aForms.view_id}
        ...
        <div class="panel-footer">
            ...
            <a href="{url link='admincp.app' id='YNC_StatusBg'}" class="btn btn-default" id="js_collection_submit">{_p var='back'}</a>
        </div>
    </div>
</form>
{literal}
