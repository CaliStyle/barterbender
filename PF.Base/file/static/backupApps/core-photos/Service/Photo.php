...
class Photo extends Phpfox_Service
{
    ...
    public function getFeedLink($iItemId)
    {
        ...
        $feed = Phpfox::getService('feed')->getParentFeedItem('photo', $iItemId);
    ...
    public function getPermissions(&$aRow)
    {
        ...
        if ($aRow['module_id'] == 'pages' || $aRow['module_id'] == 'groups') {
            ...
            } elseif ($aRow['module_id'] == 'groups' && Phpfox::getUserParam('groups.pf_group_add_cover_photo') && (Phpfox::getService('groups.facade')->getItems()->isAdmin($aRow['group_id']) || Phpfox::isAdmin() || Phpfox::getService('groups.facade')->getUserParam('can_edit_all_pages'))) {
                $aRow['canSetCover'] = true;
            }
        }
    ...
    private function canDelete($aRow)
    {
        ...
        if (!$bCanDelete) {
            ...
            } elseif ($aRow['module_id'] == 'groups' && Phpfox::isAppActive('PHPfox_Groups') && Phpfox::getService('groups')->isAdmin($aRow['group_id'])) {
