...
class Callback extends Phpfox_Service
{
    ...
    public function sendNotifyToTaggedUsers($params)
    {
        ...
        foreach ($aTagged as $iUserId) {
            ...
            Phpfox::getLib('mail')->to($iUserId)
                ...
                ->message(['user_name_tagged_you_in_a_photo_post_check_it_out',
    ...
    public function updateFeedItemInfo($data)
    {
        ...
        // Update photo info
        db()->update(Phpfox::getT('photo_info'), ['description' => $content], 'photo_id = ' . $iItemId);
    ...
    public function addComment($aVals, $iUserId = null, $sUserName = null)
    {
        ...
        Phpfox::getService('comment.process')->notify([
                ...
                'owner_subject' => ['full_name_commented_on_your_photo_title', [
                    'full_name' => Phpfox::getUserBy('full_name'),
        ...
        if ($aRow['type_id'] == 1 && $aRow['parent_user_id'] != 0 && $aRow['group_id'] == 0) {
            ...
            Phpfox::getService('comment.process')->notify([
                    ...
                    'owner_message' => ['full_name_commented_on_your_photo_a_href_link_title_a_to_see_the_comment_thread_follow_the_link_below_a_href_link_link_a',
                        [
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'link' => $sLink,
                            'title' => $aRow['title']
                    ...
                    'notify_id' => 'comment_photo',
                    'mass_id' => 'photo',
                    'mass_subject' => (Phpfox::getUserId() == $aRow['parent_user_id'] ? ['full_name_commented_on_gender_photo',
                        [
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'gender' => Phpfox::getService('user')->gender($aRow['gender'], 1)
                        ]] : ['full_name_commented_on_other_full_name_s_photo',
                        ['full_name' => Phpfox::getUserBy('full_name'), 'other_full_name' => $aRow['full_name']]]),
                    'mass_message' => (Phpfox::getUserId() == $aRow['parent_user_id'] ? ['full_name_commented_on_gender_photo_a_href_link_title_a_to_see_the_comment_thread_follow_the_link_below_a_href_link_link_a',
                        [
                            'full_name' => Phpfox::getUserBy('full_name'),
                            'gender' => Phpfox::getService('user')->gender($aRow['gender'], 1),
                            'link' => $sLink,
    ...
    public function getActivityFeed($aItem, $aCallback = null, $bIsChildItem = false)
    {
        ...
        $sTypeId = 'photo';
        $total_feed_Tag = Phpfox::getService('feed')->getTaggedUsers($iItemId, $sTypeId, true);
