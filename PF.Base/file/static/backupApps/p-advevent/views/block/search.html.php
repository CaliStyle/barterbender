...
<div class="js_p_adv_search_wrapper p-advance-search-form p-fevent-search-wrapper" style="display: none">
        ...
        <div class="p-fevent-search-formgroup-wrapper dont-unbind-children">
            ...
            <div class="form-group">
                ...
                <div>
                    <input placeholder="{_p var='fevent.advs_address'}" id="search_address" value="{value type='input' id='address'}" type="text" name="search[address]" class="form-control search_keyword">
                </div>
            </div>
            <div class="form-group">
                <label>{_p var='fevent.city'}</label>
                <div>
                    <input placeholder="{_p var='fevent.city_name'}" id="search_city" type="text" value="{value type='input' id='city'}" name="search[city]" class="form-control search_keyword">
                </div>
            </div>
            ...
            <div class="form-group">
                <div><a id="editYourCurrentLocation" href="javascript:void(0);" onclick="ynfeIndexPage.editYourCurrentLocationClick(); return false;" style="display: none;" >{_p var='fevent.advs_edit_location'}</a></div>
            </div>
        </div>
