...
<div id="js_report_body">
    ...
    <div class="p_4" align="center">
        <input type="submit" value="{_p var='fevent.yes'}" class="btn btn-sm btn-primary" onclick="tb_remove(); window.location.href='{param var='core.path_actual'}PF.Site/Apps/p-advevent/assets/gcalendar.php?event_id={$event_id}'" />&nbsp;
