...
class Install extends App\App
{
    ...
    {
        $index_blocks = $detail_blocks = $pagecalendar_block = array();

        $iCnt = db()->select('COUNT(*)')
            ->from(':block')
            ->where('m_connection = "fevent.index"')
            ->executeField();
    ...
    protected function setOthers()
    {
        ...
        $this->admincp_menu = [
            ...
            _p('admin_menu_manage_location') => 'fevent.location',
