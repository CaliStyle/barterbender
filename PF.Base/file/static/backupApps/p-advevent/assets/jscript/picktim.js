...
(function ($) {
    ...
    function Plugin(element, options) {
        ...
        this.input = $('<input>');
        this.input.addClass('p-picktim-time-input');
        ...
        this.tPopup = $('<div>');
        this.tPopup.addClass('p-picktim-container');
        this.tPopup.addClass('p-picktim-custom');
        this.tPopup.addClass('dont-unbind-children');
        ...
        this.cTable.topRow.c1 = $('<td>');
        this.cTable.topRow.c2 = $('<td>');
        this.cTable.topRow.c3 = $('<td>');
        this.cTable.topRow.c4 = $('<td>');
        this.cTable.topRow.append(this.cTable.topRow.c1, this.cTable.topRow.c2, this.cTable.topRow.c3, this.cTable.topRow.c4);
        this.cTable.midRow.c1 = $('<td class="hour-wrapper time-wrapper">');
        this.cTable.midRow.c2 = $('<td>');
        this.cTable.midRow.c3 = $('<td class="minute-wrapper time-wrapper">');
        this.cTable.midRow.c4 = $('<td>');
        this.cTable.midRow.append(this.cTable.midRow.c1, this.cTable.midRow.c2, this.cTable.midRow.c3, this.cTable.midRow.c4);
        this.cTable.botRow.c1 = $('<td>');
        this.cTable.botRow.c2 = $('<td>');
        this.cTable.botRow.c3 = $('<td>');
        this.cTable.botRow.c4 = $('<td>');
        ...
        this.tHours.val(td[0]);
        this.tHours.addClass('p-picktim-hour');
        ...
        this.tMins.val(td[1]);
        this.tMins.addClass('p-picktim-mins');
        ...
        this.incHours = $('<i>');
        this.incHours.addClass('p-picktim-btn picktim-symbol');
        ...
        this.cTable.midRow.c1.append(this.incHours);
        this.decHours = $('<i>');
        this.decHours.addClass('p-picktim-btn picktim-symbol');
        ...
        this.cTable.midRow.c1.append(this.decHours);
        this.incMins = $('<i>');
        this.incMins.addClass('p-picktim-btn picktim-symbol');
        ...
        this.cTable.midRow.c3.append(this.incMins);
        this.decMins = $('<i>');
        this.decMins.addClass('p-picktim-btn picktim-symbol');
        ...
        this.cTable.midRow.c3.append(this.decMins);
        this.clearBtn = $('<i>');
        this.clearBtn.addClass('p-picktim-clear');
        ...
        if (this.settings.mode === this.MODES.h12)
            this.ampm.addClass('p-picktim-btn p-picktim-ampm');
...
// Getter method for default value
    ...
    $.fn[pluginName] = function (methodOrOptions) {
        ...
        if (methodOrOptions === undefined || typeof methodOrOptions === 'object') {
            // Only initialise if not previously done.
            if (!instance) {
