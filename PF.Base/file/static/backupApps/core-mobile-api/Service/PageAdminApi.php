...
class PageAdminApi extends AbstractResourceApi
{
    ...
    function findAll($params = [])
    {
        ...
        if ($page['user_id'] != Phpfox::getUserId() && !$this->pageService->isAdmin($page) && !Phpfox::getUserParam('pages.can_edit_all_pages') && !$this->pageService->hasPerm($params['page_id'], 'pages.view_admins')) {
            return $this->permissionError();
        }
