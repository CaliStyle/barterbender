...
class NameResource
{
    ...
    public function __construct()
    {
        ...
        $this->objectResources = [
            ActivityPointResource::RESOURCE_NAME => ActivityPointResource::class,
            CommentResource::RESOURCE_NAME => CommentResource::class
        ];
     ...
     */
    public function getResourceByResourceName($resourceName, $resourceId)
    {
        if (!$this->hasApiResourceService($resourceName)) {
            return null;
        }
        /** @var AbstractResourceApi $service */
        $service = $this->getApiServiceByResourceName($resourceName);
    ...
    public function getPermissionByResourceName($resourceName, $resourceId, $permission = AccessControl::VIEW)
    {
        $item = $this->getResourceByResourceName($resourceName, $resourceId);
        if ($item === null) {
            return null;
        }
