...
class MusicAlbumApi extends AbstractResourceApi implements ActivityFeedInterface, MobileAppSettingInterface
{
    ...
    function findOne($params)
    {
        ...
        if (Phpfox::isModule('privacy') && !Phpfox::getService('privacy')->check('music_album', $item['album_id'], $item['user_id'], $item['privacy'],
                $item['is_friend'], true)) {
            return $this->permissionError();
        }
        $updateCounter = false;
    ...
    function sponsor($params)
    {
        ...
        $this->denyAccessUnlessGranted(MusicAlbumAccessControl::SPONSOR, $item);
