...
class FeedResource extends ResourceBase
{
    ...
    {
        return (!empty($this->rawData['feed_is_liked']) ? true : false);
    }
    ...
    public function getUser()
    {
        if ($this->rawData['profile_page_id']) {
            ...
            return UserResource::populate($this->rawData)->toArray(['full_name', 'id', 'resource_name', 'avatar', 'is_featured']);
        }
    }
    ...
    {
        return ['resource_name', 'module_name', 'like_type_id', 'comment_type_id', 'item_type', 'item_id', 'user', 'embed_object', 'privacy', 'creation_date', 'info', 'status', 'location', 'total_friends_tagged', 'tagged_friends'];
    }
