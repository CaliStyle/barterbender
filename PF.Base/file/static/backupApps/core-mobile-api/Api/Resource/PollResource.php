...
class PollResource extends ResourceBase
{
    ...
    {
        return [
            'id', 'resource_name', 'question', 'description', 'item_id', 'view_id',
            'is_featured', 'is_sponsor', 'is_user_voted', 'is_liked', 'statistic', 'user', 'privacy', 'creation_date', 'image', 'extra', 'is_closed', 'is_pending'
        ];
    }
