...
class FriendResource extends ResourceBase
{
    ...
    public function getUser()
    {
        ...
        return $resource->toArray(['id', 'full_name', 'resource_name', 'avatar', 'cover', 'summary', 'friendship', 'is_featured']);
    }
    ...
    public function _getFriendship()
    {
        ...
        $friendUserId = $this->friend_user_id;
        ...
        $iFriendRequestAwait = empty($this->rawData['is_friend_request']) ? \Phpfox::getService('friend.request')->isRequested($friendUserId, $userId) : true;
        $iFriendRequestSent = $iFriendRequestAwait ? false : \Phpfox::getService('friend.request')->isRequested($userId, $friendUserId);
        ...
        } else if ($this->accessControl->isGranted(UserAccessControl::ADD_FRIEND) && $userId != $friendUserId) {
