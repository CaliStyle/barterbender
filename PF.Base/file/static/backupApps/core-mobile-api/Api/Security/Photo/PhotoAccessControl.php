    ...
    public function isGranted($permission, ResourceBase $resource = null)
    {
        ...
        switch ($permission) {
            ...
            case self::PURCHASE_SPONSOR:
                $granted = $this->isGrantedSetting('photo.can_purchase_sponsor');
                break;
            case self::APPROVE:
            ...
            case self::SET_PROFILE_AVATAR:
                /** @var $resource PhotoResource * */
                $granted = $resource && $isOwner && !$resource->is_profile_photo;
                break;
            case self::SET_PROFILE_COVER:
                /** @var $resource PhotoResource * */
                $granted = $resource && $isOwner && !$resource->is_cover_photo;
                break;
