...
class MusicAlbumForm extends GeneralForm
{
    protected $action = "music-album";
    ...
    function buildForm($options = null, $data = [])
    {
        ...
        $this
            ...
            ->addField('name', TextType::class, [
                'label'       => 'name',
                'placeholder' => 'fill_name_for_album',
                'required'    => true
            ], [new StringLengthValidator(1, 250)], $sectionName)
            ->addField('year', IntegerType::class, [
                'label'       => 'year',
                'placeholder' => '1982',
                'description' => 'eg_1982',
                'required'    => true
            ], [new NumberRangeValidator(1)], $sectionName);
        ...
        $this
            ...
            ->addField('text', TextareaType::class, [
                'label'       => 'description',
                'placeholder' => 'add_description_to_album'
            ], null, $sectionName)
        ...
        if (empty($this->data['item_id'])) {
            $this->addPrivacyField([
                'description' => 'control_who_can_see_this_album_and_any_songs_connected_to_it'
            ], $sectionName, $this->privacy->getValue('music.default_privacy_setting_album'));
        }
