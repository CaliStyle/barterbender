	...
	<div class="profile-info-block">
		<div class="profile-image">
            <div class="profile_image_holder">
				...
				{/literal}
				<form action="#">
					<label class="btn-primary btn-gradient" onclick="$Core.ProfilePhoto.update({if $sPhotoUrl}'{$sPhotoUrl}'{else}false{/if}, {$iServerId})"><span class="ico ico-camera"></span></label>
				</form>
				{/if}
            </div>
		</div>
