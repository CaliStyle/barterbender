...
{literal}
	...
	{
		if ($Core.exists('#js_block_border_fevent_attending')){
			$('#js_block_border_fevent_attending #js_block_bottom_link_1').click(function()
			{
				$Core.box('fevent.browseList', '400', 'id=' + sEventId + '&rsvp=' + 1);
				return false;
			});
		}
