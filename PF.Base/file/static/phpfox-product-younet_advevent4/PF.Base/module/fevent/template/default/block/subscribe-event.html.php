<form method="post" action="" id="fevent_subscribe">
    ...
    <div class="form-group">
        <label>{_p var='fevent.category'}:</label>
        <div class="dropdown subscribe-categories" id="subscribe_categories">
            <span class="dropdown-toggle d-block form-control cursor-point" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><p class="subscribe-categories__text">{_p var='fevent.select_category'}</p> <i class="ico ico-caret-down subscribe-categories__icon"></i></span>
    ...
    <div class="form-group ynfevent-form-location">
        <label>{_p var='fevent.location'}:</label>
    ...
    <button type="button" value="{_p var='fevent.subscribe'}" class="btn btn-primary btn-sm" id="fevent_subscribeblock_submit">{_p var='fevent.subscribe'}</button>
</form>
{literal}
