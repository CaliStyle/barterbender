		...
		foreach ($aCategories as $iKey => $aCategory) {
			...
			//if ($iCategoryId !== null)
			{
				...
				foreach ($aCategories[$iKey]['sub'] as $iSubKey => $aSubCategory) {
					$aCategories[$iKey]['sub'][$iSubKey]['url'] = Phpfox::permalink('fevent.category', $aSubCategory['category_id'], Phpfox::getLib('locale')->convert($aSubCategory['name']));
					$aCategories[$iKey]['sub'][$iSubKey]['name'] = Phpfox::getLib('locale')->convert(Phpfox::isPhrase($aSubCategory['name']) ? _p($aSubCategory['name']) : $aSubCategory['name']);
				}
			}
		}
		return $aCategories;
