var $Material = {
  ...
  setColumnFixed: function(left_right, elem){
    ...
    checkFixedColumn = function() {
      if ($Core.exists('body#page_yncdating_landing') || $('body').css('position') == 'fixed') {
        if ($Core.exists('body#page_yncdating_landing')) {
...
$Ready(function() {
  ...
  $('.nav-mask-modal,.yncdating-main-menu-toggle .btn-close').on("click touchend", function(){
    $(this).removeClass("in");
  ...
  $(".site-menu-small .ajax_link, .site-logo-link, .yncdating-main-menu-toggle .btn-close").on("click", function(){
