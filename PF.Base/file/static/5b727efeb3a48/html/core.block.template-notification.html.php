...
<div class="guest_login_small pull-right" data-component="guest-actions">
    <a class="btn btn01 btn-primary test text-uppercase {if Phpfox::canOpenPopup('login')}popup{else}no_ajax{/if}"
    ...
    <a class="btn btn02 btn-info text-uppercase {if Phpfox::canOpenPopup('user.register')}popup{else}no_ajax{/if}"
