...
<?php if (count((array)$this->_aVars['aMyListings'])):  $this->_aPhpfoxVars['iteration']['minilistings'] = 0;  foreach ((array) $this->_aVars['aMyListings'] as $this->_aVars['aMiniListing']):  $this->_aPhpfoxVars['iteration']['minilistings']++; ?>

		<?php
						Phpfox::getLib('template')->getBuiltFile('marketplace.block.mini');
						?>
