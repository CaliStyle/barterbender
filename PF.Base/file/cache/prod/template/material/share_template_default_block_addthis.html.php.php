        ...
        <script type="text/javascript">
            $Behavior.onUpdateAddthis = function () {
                if (typeof addthis != \'undefined\') {
                    ...
                    addthis.update(\'share\', \'title\', "';  echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['sAddthisTitle']);  echo '");
                    addthis.update(\'share\', \'description\', "';  echo Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('phpfox.parse.output')->clean(strip_tags($this->_aVars['sAddthisDesc'])), 200, '...');  echo '");
