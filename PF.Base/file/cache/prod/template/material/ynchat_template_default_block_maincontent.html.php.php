...
<?php endif; ?>
<?php if (( $this->_aVars['type'] == 'web' && Phpfox ::isModule('ynchat'))): ?>
	<link id="ynchat_link_css" type="text/css" href="<?php echo $this->_aVars['sSiteLink']; ?>ynchat/css.php?v=<?php  echo time();  ?>" rel="stylesheet" charset="utf-8">
	<script id="ynchat_script_js" type="text/javascript" src="<?php echo $this->_aVars['sSiteLink']; ?>ynchat/js.php?v=<?php  echo time();  ?>" charset="utf-8"></script>
<?php endif; ?>
