 ...
 * and open the template in the editor.
  <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('gettingstarted.article'); ?>article_<?php echo $this->_aVars['article']['article_id']; ?>"><?php echo $this->_aVars['article']['title']; ?></a>
 */

?>

<ul class="action">
<?php if (count((array)$this->_aVars['article_block'])):  foreach ((array) $this->_aVars['article_block'] as $this->_aVars['article']): ?>
    <li >
        <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('gettingstarted.article'); ?>article_<?php echo $this->_aVars['article']['article_id']; ?>"><?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['article']['title']); ?></a>
    </li>
