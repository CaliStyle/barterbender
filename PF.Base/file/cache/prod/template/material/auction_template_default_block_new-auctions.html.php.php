...
<?php endif; ?>
<?php if (count ( $this->_aVars['aAuctionsHomepage'] ) > 0): ?>
<div id="ynauction_block_homepage">
    <div class="ynauction_headline">
        <div id="ynauction_menu">
<?php if (isset ( $this->_aVars['viewType'] )): ?><input type="hidden" value="<?php echo $this->_aVars['viewType']; ?>" id="ynauction_menu_viewtype" name="ynauction_menu_viewtype" ><?php endif; ?>
            ...
            <div title="<?php echo _p('list_view'); ?>" id="ynauction_listview_menu" value="listview" class="homepage-view-menu view-menu-active"></div>
            <div title="<?php echo _p('grid_view'); ?>" id="ynauction_gridview_menu" value="gridview" class="homepage-view-menu"></div>
            <div title="<?php echo _p('pinboard_view'); ?>" id="ynauction_pinboardview_menu"  value="pinboardview"  class="homepage-view-menu"></div>
        </div>
...
<?php if (count((array)$this->_aVars['aAuctionsHomepage'])):  $this->_aPhpfoxVars['iteration']['auction'] = 0;  foreach ((array) $this->_aVars['aAuctionsHomepage'] as $this->_aVars['aProduct']):  $this->_aPhpfoxVars['iteration']['auction']++; ?>
...
<?php if (count((array)$this->_aVars['aAuctionsHomepage'])):  $this->_aPhpfoxVars['iteration']['auction'] = 0;  foreach ((array) $this->_aVars['aAuctionsHomepage'] as $this->_aVars['aProduct']):  $this->_aPhpfoxVars['iteration']['auction']++; ?>
            ...
            <?php
						Phpfox::getLib('template')->getBuiltFile('auction.block.listing-product-item-pinboardview');
						?>
<?php endforeach; endif; ?>
        </div>
    </div>
