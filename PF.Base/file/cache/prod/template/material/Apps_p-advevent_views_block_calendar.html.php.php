...
<input type="hidden" name="calendar" id="calendar" value="<?php echo $this->_aVars['sDate']; ?>" data-fullmonthname="1" data-daynamewithtwocharacters="1"/>
<a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('fevent.pagecalendar'); ?>" class='p-fevent-link-view-calendar'><?php echo _p('view_my_calendar'); ?></a>
...
<script type="text/javascript">
	oTranslations['fevent_and'] = "<?php echo _p('fevent_and'); ?>";
	oTranslations['fevent_other'] = "<?php echo _p('fevent_other'); ?>";
	oTranslations['fevent_others'] = "<?php echo _p('fevent_others'); ?>";
	POOL = {
		"phrase_events":"<?php echo $this->_aVars['sPhraseEvents']; ?>",
		"events":[],
		"search":{}
	};
<?php if (count((array)$this->_aVars['aJsEvents'])):  foreach ((array) $this->_aVars['aJsEvents'] as $this->_aVars['aEvent']): ?>
<?php if (count((array)$this->_aVars['aEvent']['calendar'])):  foreach ((array) $this->_aVars['aEvent']['calendar'] as $this->_aVars['calendar']): ?>
<?php if (isset ( $this->_aVars['aEvent']['event_id'] )): ?>
	POOL.events.push({
		"event_id":<?php echo $this->_aVars['aEvent']['event_id']; ?>,
		"event_name": "<?php echo $this->_aVars['aEvent']['title']; ?>",
		"start_time":"<?php echo $this->_aVars['calendar']; ?>",
		"from": "<?php echo $this->_aVars['aEvent']['d_start_time_hour']; ?>",
		"to": "<?php echo $this->_aVars['aEvent']['detail_end_time']; ?> <?php echo $this->_aVars['aEvent']['d_end_time_hour']; ?>",
        "isrepeat":<?php echo $this->_aVars['aEvent']['isrepeat']; ?>,
        "event_url": "<?php echo $this->_aVars['aEvent']['url']; ?>",
        "event_d_type": "<?php echo $this->_aVars['aEvent']['d_type']; ?>",
	});
<?php elseif (isset ( $this->_aVars['aEvent']['bday'] )): ?>
    POOL.events.push({
    "display_name": "<?php echo $this->_aVars['aEvent']['birthday_display_name']; ?>",
    "start_time":"<?php echo $this->_aVars['calendar']; ?>",
    "event_d_type": "<?php echo $this->_aVars['aEvent']['d_type']; ?>",
    "event_url": "<?php echo $this->_aVars['aEvent']['url']; ?>",
    "is_birthday" : "1"
