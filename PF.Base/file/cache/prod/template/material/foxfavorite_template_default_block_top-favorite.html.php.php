...
<?php if (count((array)$this->_aVars['aFavorites'])):  foreach ((array) $this->_aVars['aFavorites'] as $this->_aVars['aFavorite']): ?>
	<li class="clearfix">
		<span class="ynfavo_image clearfix">
<?php if (! empty ( $this->_aVars['aFavorite']['image'] )): ?>
			<a href="<?php echo $this->_aVars['aFavorite']['link']; ?>"><?php echo $this->_aVars['aFavorite']['image']; ?></a>
<?php else: ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aFavorite'],'suffix' => '_50_square','max_width' => 50,'max_height' => 50)); ?>
<?php endif; ?>
		</span>

		<span class="ynfavo_title">
			<a class="link_title" href="<?php echo $this->_aVars['aFavorite']['link']; ?>"><?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aFavorite']['title']); ?></a>
			<span class="ynfavo_name_type">
<?php echo $this->_aVars['aFavorite']['type']; ?>
				<strong style="position:relative; top:3px">&middot;</strong>
				<span class="description">
<?php if (isset ( $this->_aVars['aFavorite']['extra_info'] )): ?>
<?php echo $this->_aVars['aFavorite']['extra_info']; ?>
<?php endif; ?>
				<strong><?php echo $this->_aVars['aFavorite']['total']; ?> <i class="fa fa-star"></i></strong>
				</span>
			</span>
