...
<?php echo $this->_aVars['iTotalLike']; ?>
    </div>
    <div class="global_like_link">	
        <a style="cursor:pointer" onclick="return $Core.box('auction.browselike', 400, 'type_id=auction&amp;item_id=<?php echo $this->_aVars['aAuction']['product_id']; ?>&amp;force_like=1');" ><?php echo _p('people_like_this'); ?></a>
    </div>
</div>
