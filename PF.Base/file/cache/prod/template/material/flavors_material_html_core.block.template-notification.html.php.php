        ...
        <ul class="dropdown-menu dropdown-menu-right dont-unbind">
            <li class="background-cover-block">
                ...
                <div class="profile-info pl-2 pr-7 py-1">
                    <div class="fullname"><?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aGlobalUser']['full_name']); ?></div>
                </div>
                <div class="edit-page">
...
<?php echo _p('log_back_in_as_global_full_name', array('global_full_name' => Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aGlobalProfilePageLogin']['full_name']))); ?>
                </a>
            </li>
        </ul>
<?php else: ?>
...
<?php if (! empty ( $this->_aVars['aCurentUser']['full_name'] )): ?>
                    <div class="fullname"><?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aCurentUser']['full_name']); ?></div>
<?php endif; ?>
...
<?php if (isset ( $this->_aVars['showMembership'] )): ?>
                <li role="presentation">
                    <a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('subscribe'); ?>">
