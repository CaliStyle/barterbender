...
<div id="js_ync_statusbg_collection_list" style="display: none;">
	...
	<div class="ync-statusbg-collection-container">
	    <ul class="nav ync-statusbg-collection-header" <?php if ($this->_aVars['iTotalCollection'] == 1): ?>style="display:none"<?php endif; ?>>
<?php if (count((array)$this->_aVars['aCollections'])):  foreach ((array) $this->_aVars['aCollections'] as $this->_aVars['aCollection']): ?>
			    <li class="<?php if (! $this->_aVars['aCollection']['is_default'] || $this->_aVars['iTotalCollection'] == 1): ?>active<?php endif; ?> js_ync_switch_collection_li "><a class="item-collection js_ync_switch_collection" data-toggle="tab" href="#ync_collection_<?php echo $this->_aVars['aCollection']['collection_id']; ?>"><?php echo _p($this->_aVars['aCollection']['title']); ?></a></li>
...
<?php if (count((array)$this->_aVars['aCollections'])):  foreach ((array) $this->_aVars['aCollections'] as $this->_aVars['aCollection']): ?>
                 <div class="tab-pane <?php if (! $this->_aVars['aCollection']['is_default'] || $this->_aVars['iTotalCollection'] == 1): ?>active<?php endif; ?>" id="ync_collection_<?php echo $this->_aVars['aCollection']['collection_id']; ?>">
...
<?php if (count((array)$this->_aVars['aCollection']['backgrounds_list'])):  foreach ((array) $this->_aVars['aCollection']['backgrounds_list'] as $this->_aVars['iKey'] => $this->_aVars['aBackground']): ?>
                             <div class="collection-item <?php if ($this->_aVars['iKey'] > 13): ?>hide js_ync_bg_hide_<?php echo $this->_aVars['aCollection']['collection_id'];  endif; ?>" data-background_id="<?php echo $this->_aVars['aBackground']['background_id']; ?>" data-image_url="<?php echo $this->_aVars['aBackground']['full_path']; ?>" onclick="yncstatusbg.selectBackground(this);">
                                 <div class="item-outer">
...
<?php if ($this->_aVars['iKey'] > 13): ?>
                             <div class="collection-item js_ync_bg_show_full" data-collection_id="<?php echo $this->_aVars['aCollection']['collection_id']; ?>" onclick="yncstatusbg.showFullCollection(this); return false;">
                                 <div class="item-outer">
